      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    />
                    <div className={`absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-green-500 to-yellow-500 transform origin-left transition-transform duration-300 ${
              ...
              <div className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="e.g., BSCS-2A, BSIT-3B, Grade 12-STEM"
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-10 border border-green-200/30 hover:shadow-3xl transition-all duration-500 ring-1 ring-green-100/50">
            <div className="mb-8">
              <div className="flex items-center mb-4">
                <h2 className="text-3xl font-bold text-green-800 mb-2">Official QR Code</h2>
              </div>
              <p className="text-green-700">Your NCF student QR code will appear here</p>
            </div>
